...
def synchronize_structure_data(accountId, url, prefix):
	...
	while(True):
		...
		with open(file_path, 'wb') as out:
			json.dump(decoded_response, out, sort_keys=True, indent=4, separators=(',', ': '))
		print 'push file ' + file_name
...
if __name__ == '__main__':
	synchronize_report_data(1256, constants.REPORT_CAMPAIGN_URL, constants.REPORT_CAMPAIGN_PREFIX)
	synchronize_structure_data(1256, constants.MEDIA_URL, constants.MEDIA_PREFIX)
